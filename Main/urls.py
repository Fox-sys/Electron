...
urlpatterns = [
    ...
    path('create_thread/<str:type>', CreatePost.as_view(), name = 'New_Art_url'),
    path('forum/<str:id>', Post_detail.as_view(), name = "art_url"),
    ...
    path('Lessons', Post_list.as_view(), name= "art_list_url"),
    path('Lesson/<str:q>', Post_l_det, name= "art_det_url"),
